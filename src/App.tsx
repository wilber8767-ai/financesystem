          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <section className="bg-white p-8 rounded-3xl border-2 border-blue-100 md:col-span-2 shadow-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div><label className="text-base font-medium font-bold text-indigo-700">該險種年保費</label><input type="number" className="w-full text-lg p-3 mt-1 border-2 border-indigo-500 rounded-xl bg-indigo-50" onChange={e => setInsurance({...insurance, medical: {...insurance.medical, premium: Number(e.target.value)}})} /></div>
              </div>
            </section>
          ...
          <div className="sticky top-10 space-y-8">
            <section className="bg-blue-900 text-white p-8 rounded-[2rem] shadow-2xl relative overflow-hidden">
              ...
              <div className="space-y-6 relative z-10">
                ...
                <div className="bg-blue-800/50 p-6 rounded-2xl border border-blue-700">
                  <p className="text-blue-200 font-bold text-sm uppercase">年結餘 (財富種子)</p>
                ...
                <div className="pt-6 space-y-4">
                  ...
                  <div className="space-y-3 text-sm">
                    {insurance.medical.miscReimburse < 200000 && <div className="p-4 bg-red-500/20 border-l-4 border-red-500 rounded-r-lg">⚠️ 醫療雜費不足：目前自費醫材昂貴，建議補強。</div>}
                    {netSavings < 0 && <div className="p-4 bg-red-500/20 border-l-4 border-red-500 rounded-r-lg">❌ 財務結構崩潰：支出已超過收入。</div>}
                    {totalPremium > finance.income * 0.15 && <div className="p-4 bg-yellow-500/20 border-l-4 border-yellow-500 rounded-r-lg">⚠️ 保費佔比過高，影響財富累積效率。</div>}
                  </div>
                </div>
